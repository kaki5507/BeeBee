...
<div class="board-wrap">
    ...
    <div class="board-side-menu">
        <ul>
            ...
            <li class="side-select-menu"><a href="<c:url value='/board/board-listFree'/>">자유게시판</a></li>
    ...
    <!---- searchForm ---->
    <form class="searchForm" action="/board/board-listFree" method="get">
        <div><h2>게시판</h2></div>
        <div class="searchBar">
	...
	<form id='actionForm' action="/board/board-listFree" method='get'>
