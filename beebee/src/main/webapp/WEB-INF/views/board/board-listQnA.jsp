...
<div class="board-wrap">
    ...
    <div class="board-side-menu">
        <ul>
            ...
            <li class="side-select-menu"><a href="<c:url value='/board/board-listQnA'/>">질문게시판</a></li>
    ...
    <!---- searchForm ---->
    <form class="searchForm" action="/board/board-listQnA" method="get">
        <div><h2>게시판</h2></div>
        <div class="searchBar">
	...
	<form id='actionForm' action="/board/board-listQnA" method='get'>
